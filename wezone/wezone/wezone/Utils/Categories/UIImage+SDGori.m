...
#import "UIImage+SDGori.h"

@implementation UIImage (SDGori)
...
- (UIImage *)maskImageFromImageAlpha
{
    ...
    CGContextRef context = CGBitmapContextCreate(data, width, height, 8, bytesPerRow, NULL, (CGBitmapInfo)kCGImageAlphaOnly); // KJH
